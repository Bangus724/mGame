...
Require Controllers with `require(ReplicatedStorage.Controllers.X)` / `require(ServerScriptService.Controllers.X)`. Gameplay uses `game:GetService`; Fusion UI may use `game.ReplicatedStorage.Packages…`.
