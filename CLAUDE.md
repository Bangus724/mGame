...
mGame is a Roblox **1vAll hidden-role** arena: one Killer vs one Sheriff + Civilians. Pitch: `README.md`. Constraints: `.claude/rules/game-design.md`.
...
- @.claude/rules/game-design.md — always
